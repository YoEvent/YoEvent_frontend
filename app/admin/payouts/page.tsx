...
import { DollarSign, Send, Landmark, RefreshCw, Clock, ArrowUpRight, HelpCircle } from "lucide-react";
...
export default function PayoutsPage() {
  ...
  const handleWithdrawalRequest = async (e: React.FormEvent) => {
    ...
    if (withdrawAmount > balance) {
      showToast("error", `Insufficient balance. Available is ${balance} ${currency}`);
      return;
    }
    ...
    try {
      ...
      showToast("error", err.message || "Withdrawal failed. Check your payout destination configuration under settings.");
    } finally {
      setSubmitting(false);
    }
  };
