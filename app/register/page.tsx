    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1 grid md:grid-cols-2">
        ...
        <div className="relative bg-gradient-to-br from-[#1a1a1a] to-[#2a1e10] px-14 py-16 flex flex-col justify-center overflow-hidden">
          <div className="absolute -top-20 -right-20 w-80 h-80 rounded-full bg-radial-[at_50%_50%] from-[#F7E998]/15 to-transparent" />
          <div className="absolute -bottom-16 -left-16 w-60 h-60 rounded-full bg-radial-[at_50%_50%] from-[#efe084]/10 to-transparent" />
          <div className="relative z-10">
            <span className="inline-block bg-[#EB4203]/10 border border-[#F7E998]/25 rounded-full px-4 py-1.5 text-xs text-[#F7E998] uppercase tracking-widest mb-8">Get Started Today</span>
            <h2 className="font-display text-4xl font-bold text-white leading-[1.15] tracking-tight mb-5">
              Your events,<br /><em className="italic text-[#F7E998]">your rules.</em>
            </h2>
            ...
            <div>
              ...
              {paymentSuccess ? (
                ...
                <form onSubmit={handlePaymentSubmit} className="space-y-4">
                  ...
                  {/* Visual Card */}
                  <div className="relative w-full h-40 rounded-2xl bg-gradient-to-br from-[#1a1a1a] to-[#3a2f1d] border border-[#F7E998]/25 p-5 text-white flex flex-col justify-between shadow-lg overflow-hidden">
                    <div className="absolute top-0 right-0 w-24 h-24 bg-radial-[at_100%_0%] from-[#F7E998]/10 to-transparent" />
                    <div className="flex justify-between items-start">
                      <span className="text-[9px] uppercase tracking-widest text-[#F7E998] font-bold">YowEvent Premium</span>
